...
Usage:
    confilis.py -i "<SMILES>" -l <library_dir1> [<library_dir2> ...] -f <fingerprint1> [<fingerprint2> ...] [--cores <num>]
...
def parse_arguments() -> argparse.Namespace:
    ...
    confilis.py -i "C1=CC=CC=C1" -l ./lib1 ./lib2 -f circular rdk-maccs --cores 4
